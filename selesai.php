...
<body>
    ...
    <?php
			if($_POST['finish']){
				...
				echo '<p>Total biaya untuk pembelian Produk adalah Rp. '.$_POST['total'].',- dan biaya bisa di kirimkan melalui Rekening Bank Mandiri  dengan nomor rekening 123-234-56347-8 atas nama Distro ID.</p>';
