...
<link rel="shortcut icon" href="img/favicon.png">
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Distro ID | Toko baju online </title> 
...
<body>
	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				<h2><font color="black">T-Shirt Casual</font></h2>
				<p><font color="white" >Kami menyediakan kaos sport dan casual yang nyaman anda kenakan setiasp hari juga update dengan perkermbangan mode di era sekarang ini.</font></p>
				<a href="#" class="da-link"><font color="black">Lihat Produk</font></a>
				<div class="da-img"><img src="img/parallax-slider/kaos.png" alt="image01" /></div>
			</div>
			<div class="da-slide">
				<h2><font color="black">Jacket & Sweater</font></h2>
				<p><font color="white" >Kami memiliki banyak koleksi jacket dan sweater, mulai dari rider jacket hingga casual jacket dan juga casual sweater yang cocok dipakai sehari hari.</font></p>
				<a href="#" class="da-link"><font color="black">Lihat Produk</font></a>
				<div class="da-img"><img src="img/parallax-slider/jaket5.png" alt="image02" /></div>
			</div>
			<div class="da-slide">
				<h2><font color="black">Pants & Jeans</font></h2>
				<p><font color="white" >Kami memiliki koleksi jeans dan celana santai yang bisa anda gunakan sehari hari dengan harga yang terjangkau anda bisa memiliki koleksi kami.</font></p>
				<a href="#" class="da-link"><font color="black">Lihat Produk</font></a>
				<div class="da-img"><img src="img/parallax-slider/jeans.png" alt="image03" /></div>
			</div>
			<div class="da-slide">
				<h2><font color="black">Custom T-Shirt</font></h2>
				<p><font color="white" >Kami menerima pembuatan kaos custom sesuai dengan design keinginan anda dengan harga yang bisa di sesuaikan dengan kebutuhan anda.</font></p>
				<a href="#" class="da-link"><font color="black">Lihat Produk</font></a>
...
<!---->
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Dapatkan kemudahan berbelanja di Distro, Kami menyediakan kebutuhan untuk fasion anda.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span3">
					...
					<h3>Tentang Distro ID</h3>
					<p>
						Distro ID adalah toko online yang bergerak di bidang fasion, sasaran kami semua kalangan baik muda maupun tua, mulai dari anak - anak dan orang dewasa.
					</p>
				...
				<div class="span3">
					...
					<h3>Alamat Kami</h3>
					Jl. Indonesia Raya No.45, Kota Bekasi, Jawa Barat 12345<br />
                    Telp : 085123456789<br />
                    Email : <a href="mailto:distroid@gmail.com">distroid@gmail.com</a>
				</div>
				<!-- end: Photo Stream -->
	...
	<div id="copyright">
		...
		<div class="container">
			...
			<p>
				Copyright &copy; <a href="">DistroID </a> <a href="http://bootstrapmaster.com" alt="Bootstrap Themes">Bootstrap Themes</a> designed by BootstrapMaster
			</p>
